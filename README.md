...
![stock Market](Images/week-2-vba_homework_Images_stockmarket.jpg)
...
![moderate_solution](Images/week-2-vba_homework_Images_moderate_solution.png)

## BONUS

* Your solution will also be able to return the stock with the "Greatest % increase", "Greatest % decrease" and "Greatest total volume". The solution will look as follows:

![hard_solution](Images/week-2-vba_homework_Images_hard_solution.png)
